...
Il est conçu, enrichi et mis à jour bénévolement. A ce titre certaines, ressources peuvent être incomplètes, obsolètes ou en cours d'implémentation. Les contributions (corrections, suggestions...) sont les bienvenues via [GitHub](https://github.com/marvinjacquet/phare/issues/new) ou par mail.

Accès : [PHARE](https://marvinjacquet.github.io/phare/)
